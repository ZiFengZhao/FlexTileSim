#!/bin/bash
# ==================================================
# NPU Simulation Sweep Script with Timeout
# ==================================================
# Workloads: alexnet, resnet18, vgg16, vit, bert
# Core numbers: 4, 8, 16, 32, 64
# ==================================================

WORKLOADS=("alexnet" "resnet18" "vgg16" "bert_base" "vit_large")
#WORKLOADS=("alexnet")
CORE_NUMS=(4 8 16 32 64)
...
TIMEOUT_DURATION="30m" #"2h"、"30m"、"60s"
TIMEOUT_CMD="timeout"  
