...
def main():
    ...
    SZ_PROJ = 0x90000   # 768 * 768
    SZ_FFN  = 0x240000  # 768 * 3072
    SZ_VEC  = 0x1000
    ...
    K_buf         = Q_buf + 0x30000
    V_buf         = K_buf + 0x30000
    score_buf     = V_buf + 0x30000
    context_buf   = score_buf + 0xC0000
    attention_buf = context_buf + 0x30000
    GeLU_buf      = attention_buf + 0xC0000
    ...
    print(f"// ViT-Base instructions generated. Final output addr: 0x{final_output:X}")
    for inst in instrs:
        print(inst)
